        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EtaMinMinutes = table.Column<int>(type: "int", nullable: false),
                    EtaMaxMinutes = table.Column<int>(type: "int", nullable: false),
                    HotlinePhones = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    EstimatedDeliveryTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "BuilderOptionGroups",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupKey = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IsSingleSelect = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuilderOptionGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraPrice = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    BuilderOptionGroupId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuilderOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuilderOptions_BuilderOptionGroups_BuilderOptionGroupId",
                        column: x => x.BuilderOptionGroupId,
                        principalTable: "BuilderOptionGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageObjectKey = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerReceivedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Stage = table.Column<byte>(type: "tinyint", nullable: false),
                    TriggeredBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    GatewayProvider = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    CashRefundNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CashRefundNotedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuilderOptions_BuilderOptionGroupId",
                table: "BuilderOptions",
                column: "BuilderOptionGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotencyRecords_Endpoint_ScopeId_Key",
                table: "IdempotencyRecords",
                columns: new[] { "Endpoint", "ScopeId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuCategories_Key",
