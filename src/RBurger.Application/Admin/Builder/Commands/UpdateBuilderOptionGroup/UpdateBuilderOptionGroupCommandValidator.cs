...
public class UpdateBuilderOptionGroupCommandValidator : AbstractValidator<UpdateBuilderOptionGroupCommand>
{
    public UpdateBuilderOptionGroupCommandValidator()
    {
